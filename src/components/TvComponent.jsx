...
import tvtwo from "../componentsSrcAssets/televisionfour.jpg";
...
import tvsix from "../componentsSrcAssets/televisionsix.jpg";
        ...
        <Container className="tv-grid-container">
          ...
          <Row className="tv-grid-item">
            ...
            <Col md={6} className="tv-grid-description">
              ...
              <p>
                Optimize your TV’s color, brightness, contrast, and more with
                our expert calibration service for the best viewing experience.
              </p>
              <Button variant="outline-primary">Learn More</Button>
            </Col>
          </Row>
